  ...
  return (
    <section className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 py-20 md:py-28 border-y border-gray-200/80 dark:border-white/[0.06] bg-gray-50/60 dark:bg-white/[0.02]">
      <SectionHeader
        ...
        description="Each visual matches a real program: revenue, delivery, care, operations, and brand presence. Open any card to read the story behind the drawing."
        align="center"
      />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
        {DIAGRAM_GALLERY_ITEMS.map((item, i) => (
          <motion.article
            ...
            className="rounded-2xl border border-gray-200/90 bg-white/90 p-5 sm:p-6 dark:border-white/10 dark:bg-white/[0.04] transition hover:border-emerald-400/30 hover:shadow-lg dark:hover:border-cyan-400/20"
          >
