      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-12 lg:py-16">
        <div className="mb-6" data-reveal="fade-up">
          ...
          <p className="mt-1 text-sm text-stone-500 dark:text-stone-400">
            Deployed sites you can open — including website chat helpers built for real businesses.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5" data-project-group="featured">
          {featuredProjects.map((project) => (
            <article
              ...
              className="surface-card group rounded-xl border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-white/[0.03]"
            >
              ...
              <div className="mt-1 text-[11px] tracking-[0.14em] uppercase text-accent">
                {project.category}
              </div>
              <div className="mt-1 text-[11px] tracking-[0.14em] uppercase text-stone-500 dark:text-stone-400">
                {project.stack}
              </div>
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-2">
                  <button
                    ...
                    className="inline-flex rounded-lg px-3 py-1.5 text-xs font-semibold text-accent border border-accent/30"
                  >
